...
<!-- this page takes the reference from http://www.sellshoe.net-->
  ...
  <body onload="setSize();">
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
      <table width="100%">
        <tr>
          <td><img src="images/products/shoes/shoe2_d.png" alt="index"/></td>
          <td><p>Christian Louboutin Satin d'Orsays<br/> PinkChristian Louboutin Blue leather pigalle pumps, pointed toe ,13cm heel,Signature red sole<hr/></p>
          <p>Price:<span style="color:#f61200">&#32;AUD &#36;188</span> &#47;piece</p>
          ...
          <input type="hidden" name="name" value="shoe2"/>
          <input type="hidden" name="title" value="Christian Louboutin Satin d'Orsays PinkChristian Louboutin Blue"/>
...
<li>Toe Style:&#32;Half Opened</li>
<li>Toe Shape:&#32;Round Toe</li>
<li>Heel Hight:&#32;High 13cm</li>
...
<li>Outsole Material:&#32;Rubber</li>
        ...
        <tr>
          <td colspan="2" align="center">
           <img src="images/products/shoes/shoe2_1.jpg" alt="1"/><br/>
           <img src="images/products/shoes/shoe2_2.jpg" alt="2"/><br/>
           <img src="images/products/shoes/shoe2_3.jpg" alt="3"/><br/>
          </td>
        </tr>
      </table>
      </form>
