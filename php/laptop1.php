...
<!-- this page takes the reference from http://www.bhphotovideo.com-->
  ...
  <body onload="setSize();">
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
      <table width="100%">
        <tr>
          <td><img src="images/products/laptop/laptop1_d.png" alt="laptop1"/></td>
          <td><p>Lenovo ThinkPad T420s 14&#34; Notebook Computer (Black)<hr/></p>
          <p>Price:<span style="color:#f61200">&#32;AUD &#36;820</span> &#47;piece</p>
          ...
          <input type="hidden" name="name" value="laptop1"/>
          <input type="hidden" name="title" value="Lenovo ThinkPad T420s 14&#34; Notebook Computer"/>
        ...
        <tr>
          ...
          <hr/>
          <p>
          <span style="color:#cc6600">Product Highlights</span>
         </p>
         <ul>
          <li>2.5GHz Intel Core i5-2520M Dual-Core</li>
          <li>4GB of DDR3 RAM</li>
          <li>320GB Hard Drive</li>
          <li>Integrated Intel HD Graphics</li>
          <li>14" HD Widescreen LED-Backlit Display</li>
          <li>1600 x 900 Native Resolution</li>
          <li>SuperMulti DVD Burner</li>
          <li>802.11a/b/g/n Wi-Fi, Bluetooth 3.0+HS</li>
          <li>Integrated Webcam, Microphone & Speakers</li>
        ...
        <tr>
          <td colspan="2" align="center">
           <img src="images/products/laptop/laptop1_1.jpg" alt="1"/><br/>
           <img src="images/products/laptop/laptop1_2.jpg" alt="2"/><br/>
           <img src="images/products/laptop/laptop1_3.jpg" alt="3"/><br/>
           <img src="images/products/laptop/laptop1_4.jpg" alt="4"/><br/>
          </td>
        </tr>
      </table>
      </form>
